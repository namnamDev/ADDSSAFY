            ...
            <dl>
              ...
              <div className=" px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500">주소</dt>
                {
                  editinfo
                    ? <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      <input type="text" defaultValue={person.userAddress} className="w-full" onChange={(e) => console.log(e.target.value)} />
                    </dd>
                    : <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {person.userAddress}
                    </dd>
              ...
              <div className="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500">연락처</dt>
                {
                  editinfo
                    ? <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      <input type="text" defaultValue={person.userPhone} className="w-full" onChange={(e) => console.log(e.target.value)} />
                    </dd>
                    : <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {person.userPhone}
                    </dd>
              ...
              <div className=" px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                </dt>
                {
                  editinfo
                    ? <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      <input type="text" defaultValue={person.email} className="w-full" onChange={(e) => console.log(e.target.value)} />
                    </dd>
                    : <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {person.email}
                    </dd>
