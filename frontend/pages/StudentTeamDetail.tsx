...
function StudentTeamDetail({ }: Props): ReactElement {
    ...
    const url = [
        "https://github.com", "https://ssafyclass.webex.com/join/jonghan1983", "https://gitlab.com", "kakaoTalk"
    ]
    return (
        <div>
            <StudentNavbar />
                    ...
                    <div className="grid grid-cols-3 gap-10 mx-5">
                        <div className="container">
                            <ul className="divide-y divide-gray-300">
                                {
                                    url.map((site) =>
                                        <li className="p-4 hover:bg-gray-50 cursor-pointer" key="site" onClick={() => router.push(site)}>
                                            {site}
                                        </li>
                                    )
                                }
                        ...
                        <div className="col-span-2">
                            <h2 className="text-2xl font-extrabold traRcking-tight text-gray-900 mb-5">가입희망 교육생</h2>
                            ...
                            <h2 className="text-2xl font-extrabold traRcking-tight text-gray-900 mb-5">영입제안한 교육생</h2>
