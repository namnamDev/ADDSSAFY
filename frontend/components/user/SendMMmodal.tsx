                        ...
                        >
                            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900">
                                            <MailIcon className="h-6 w-6 text-blue-800 float-left mr-2" aria-hidden="true" />Mattermost Message 보내기
                                        </Dialog.Title>
                                        <div className="mt-2">
                                            <input
                                                type="textarea"
                                                ...
                                                className="mt-1 block shadow-sm rounded-md w-full border-2"
                                                multiple
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    <button
                                        type="button"
                                        className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 sm:ml-3 sm:text-sm"
                                        onClick={sendMessage}
                                    >
                                        Send
                                    </button>
